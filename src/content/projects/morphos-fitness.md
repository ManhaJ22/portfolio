...
Morphos Fitness is a full-stack AI fitness coaching platform featuring:

- Real-time pose estimation (OpenCV + FastAPI)
- Emotion-aware feedback
- Personalized workout analytics
- Modern Next.js frontend with Tailwind UI
